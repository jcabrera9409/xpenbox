...
public class UserTokenServiceImpl implements IUserTokenService {
    ...
    public void verifyEmailToken(String token) {
        ...
        if (userToken.getExpiresAt().isBefore(DateFunctions.currentLocalDateTime())) {
    ...
    private UserToken generateEmailVerificationToken(User user) {
        ...
        LocalDateTime expiresAt = DateFunctions.currentLocalDateTime().plusSeconds(emailTokenExpiration / 1000);
